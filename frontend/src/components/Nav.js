    ...
    return (
        <img
            ...
            style={{
                width,
                height,
                filter: isActive ? "invert(46%) sepia(67%) saturate(447%) hue-rotate(92deg) brightness(90%) contrast(87%)" : "invert(35%) sepia(0%) saturate(0%) hue-rotate(340deg) brightness(93%) contrast(86%)",
            }}
        />
    );
}
