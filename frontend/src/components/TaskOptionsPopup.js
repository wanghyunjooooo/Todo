                  ...
                  >
                    ...
                    >
                      <div
                        ...
                        style={{ left: repeatEnabled ? "14px" : "2px" }}
                      ></div>
                    </div>
                  </div>
                </div>
          ...
          <div className="editor-box" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="title-box">
              ...
              >
                <div
                  className="toggle-container"
                  style={{ background: repeatEnabled ? "#4CAF50" : "#CCC" }}
                >
                  <div
                    className="toggle-switch"
                    style={{ left: repeatEnabled ? "14px" : "2px" }}
                ...
                {Array.from({ length: 12 }, (_, i) => i * 5).map((m) => (
                  <button
                    className={`minute-btn ${
                      alarmDate.getMinutes() === m ? "selected" : ""
                    }`}
                    key={m}
                    onClick={() => {
                      const newDate = new Date(alarmDate);
                    ...
                    const payload = {
                      task_name:
                        typeof newText === "string" && newText.trim() !== ""
                          ...
                          : taskData.task_name,
                      memo:
                        typeof taskData.memo === "string" ? taskData.memo : "",
                      task_date:
