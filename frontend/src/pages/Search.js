...
import ClockIcon from "../assets/alarm2.svg";
                        ...
                        {history.map((h, idx) => (
                            <div key={idx} className="search-history-item">
                                <div className="search-history-item-icon">
                                    ...
                                    >
                                        <path
                                            d="M9.99951 4.49976C13.037 4.49984 15.4995 6.96224 15.4995 9.99976C15.4994 13.0372 13.037 15.4997 9.99951 15.4998C6.962 15.4998 4.4996 13.0372 4.49951 9.99976C4.49951 6.96219 6.96194 4.49976 9.99951 4.49976Z"
                                            stroke="#777777"
                                        />
                                        <path
                                            d="M10 6.69995V9.99986L11.8 11.7998"
                                            stroke="#777777"
